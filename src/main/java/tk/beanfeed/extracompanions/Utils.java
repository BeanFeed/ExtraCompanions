...
public class Utils {
    ...
    public static String getRandomMaleName() {
        ...
        return maleNames[rand.nextInt(0,999)];
    }

    public static String getRandomFemaleName() {
        Random rand = new Random();
        return femaleNames[rand.nextInt(0,999)];
    }

    public static boolean isWithin(int num, int base, int bound) {
        return base <= num && num <= bound;
    }
